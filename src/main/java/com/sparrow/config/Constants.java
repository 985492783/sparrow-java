...
public class Constants {
    ...
    public static final String SPARROW_GRPC_ADDR = "sparrow.grpc.addr";

    public static final String DEFAULT_SPARROW_GRPC_ADDR = "127.0.0.1:9854";

    public static final String SPARROW_APP_NAME = "sparrow.application.name";
