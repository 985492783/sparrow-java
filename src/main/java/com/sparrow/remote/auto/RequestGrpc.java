...
public final class RequestGrpc {
  ...
  public static final String SERVICE_NAME = "proto.Request";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.sparrow.remote.auto.Payload,
      com.sparrow.remote.auto.Payload> getRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "request",
      requestType = com.sparrow.remote.auto.Payload.class,
      responseType = com.sparrow.remote.auto.Payload.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sparrow.remote.auto.Payload,
      com.sparrow.remote.auto.Payload> getRequestMethod() {
    io.grpc.MethodDescriptor<com.sparrow.remote.auto.Payload, com.sparrow.remote.auto.Payload> getRequestMethod;
      ...
      synchronized (RequestGrpc.class) {
        if ((getRequestMethod = RequestGrpc.getRequestMethod) == null) {
          RequestGrpc.getRequestMethod = getRequestMethod =
              io.grpc.MethodDescriptor.<com.sparrow.remote.auto.Payload, com.sparrow.remote.auto.Payload>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "proto.Request", "request"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sparrow.remote.auto.Payload.getDefaultInstance()))
  ...
  public static abstract class RequestImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void request(com.sparrow.remote.auto.Payload request,
        io.grpc.stub.StreamObserver<com.sparrow.remote.auto.Payload> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.sparrow.remote.auto.Payload,
                com.sparrow.remote.auto.Payload>(
  ...
  public static final class RequestBlockingStub extends io.grpc.stub.AbstractStub<RequestBlockingStub> {
     ...
     * </pre>
     */
    public com.sparrow.remote.auto.Payload request(com.sparrow.remote.auto.Payload request) {
  ...
  public static final class RequestFutureStub extends io.grpc.stub.AbstractStub<RequestFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sparrow.remote.auto.Payload> request(
        com.sparrow.remote.auto.Payload request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST:
          serviceImpl.request((com.sparrow.remote.auto.Payload) request,
              (io.grpc.stub.StreamObserver<com.sparrow.remote.auto.Payload>) responseObserver);
          break;
        default:
  ...
  private static abstract class RequestBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sparrow.remote.auto.GrpcService.getDescriptor();
    }
